...
Для генерации параметров в файле .env были использованы следующие параметры:
```()
...
Был проанализирован трафик на наличие нежелательных доменов при помощи OpenCTI. 

## Вывод

OpenCTI - хорошая платформа для анализа трафика. Мной были изучены аспекты работы с Threat Intelligence OpenCTI.
